...
parser.add_argument('--dataset_name', dest='dataset_name', default='chess/', help='name of the dataset')
...
parser.add_argument('--load_size', dest='load_size', type=int, default=32, help='scale points to this size')
...
parser.add_argument('--input_nc', dest='input_nc', type=int, default=136, help='# of input image channels')
parser.add_argument('--output_nc', dest='output_nc', type=int, default=3, help='# of output image channels')
parser.add_argument('--niter', dest='niter', type=int, default=400, help='# of iter at starting learning rate')
